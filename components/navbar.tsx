...
export default function Navbar({ session, permissao }: NavbarProps) {
  ...
  return (
    <>
      <header className="bg-[#A5942B] dark:bg-zinc-800 text-white sticky top-0 z-50" role="banner">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <Link href={"/"} aria-label="Página inicial - Concurso Nacional de Mobiliário Urbano">
            <Image
              src="/logo-header.png"
          ...
          <nav className="hidden md:flex gap-6" role="navigation" aria-label="Navegação principal">
            <Link href="/" className="text-sm hover:underline focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#A5942B] rounded px-1">
              Início
            </Link>
            <a 
              href="#info" 
